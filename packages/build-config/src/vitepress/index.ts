 ...
 */
export const vitepress =(sidebarItems:Sidebar,_options?:DefaultVitepressConfig):DefaultVitepressConfig=> {
    const options_to_merge:DefaultVitepressConfig = (_options !== undefined)?_options: {}
    ...
    },options_to_merge) as UserConfig
