 ...
 * sets. Uses a simple backslash escape when it’s always valid, and a `\xnn`
 ...
 * @param escape - Optional. Specifies whether to escape the string if it is
 *   invalid RegExp. Default is true.
 * @returns If the string is not a valid regexp and escape is set to false, will
 *   return undefined
 */
